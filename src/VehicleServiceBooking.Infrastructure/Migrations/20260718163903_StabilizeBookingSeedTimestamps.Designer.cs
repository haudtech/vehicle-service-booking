...
namespace VehicleServiceBooking.Infrastructure.Migrations
{
    ...
    [Migration("20260718163903_StabilizeBookingSeedTimestamps")]
    partial class StabilizeBookingSeedTimestamps
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VehicleServiceBooking.Domain.Entities.AppointmentStatusLookup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1460),
                            Description = "Appointment is scheduled",
                            IsActive = true,
                            Name = "Booked",
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1460)
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1470),
                            Description = "Service is currently being performed",
                            IsActive = true,
                            Name = "In Progress",
                            Status = 2,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1470)
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1480),
                            Description = "Service has been completed",
                            IsActive = true,
                            Name = "Completed",
                            Status = 3,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1480)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1510),
                            Description = "Some services completed, others rescheduled",
                            IsActive = true,
                            Name = "Partially Completed",
                            Status = 5,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(1510)
                        });
                });
            ...
            modelBuilder.Entity("VehicleServiceBooking.Domain.Entities.IdempotencyRequestStatusLookup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(7510),
                            Description = "Request processing started and not yet completed",
                            IsActive = true,
                            Name = "In Progress",
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(7510)
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000002"),
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(7520),
                            Description = "Request completed and response persisted for replay",
                            IsActive = true,
                            Name = "Completed",
                            Status = 2,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 745, DateTimeKind.Utc).AddTicks(7520)
                        });
                });
            ...
            modelBuilder.Entity("VehicleServiceBooking.Domain.Entities.ServiceStatusLookup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 746, DateTimeKind.Utc).AddTicks(620),
                            Description = "Service scheduled but not started",
                            IsActive = true,
                            Name = "Pending",
                            Status = 0,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 746, DateTimeKind.Utc).AddTicks(620)
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0001-000000000002"),
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 746, DateTimeKind.Utc).AddTicks(630),
                            Description = "Service is currently being performed",
                            IsActive = true,
                            Name = "In Progress",
                            Status = 1,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 746, DateTimeKind.Utc).AddTicks(630)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 746, DateTimeKind.Utc).AddTicks(640),
                            Description = "Service was cancelled or declined",
                            IsActive = true,
                            Name = "Skipped",
                            Status = 3,
                            UpdatedAt = new DateTime(2026, 7, 18, 16, 39, 2, 746, DateTimeKind.Utc).AddTicks(640)
                        },
                        new
                        {
